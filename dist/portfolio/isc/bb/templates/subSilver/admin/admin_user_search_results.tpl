...
<table width="100%" cellspacing="2" cellpadding="2" border="0" align="center">
   <tr>
      <td align="center" class="nav"><span class="gen">{L_SORT_OPTIONS}</span> <a href="{U_USERNAME}">{L_USERNAME}</a> | <a href="{U_POSTS}">{L_POSTS}</a> | <a href="{U_JOINDATE}">{L_JOINDATE}</a> | <a href="{U_LASTVISIT}">{L_LASTVISIT}</a></td>
   </tr>
</table>
<p>&nbsp;</p>
<table width="100%" cellspacing="2" cellpadding="2" border="0" align="center">
