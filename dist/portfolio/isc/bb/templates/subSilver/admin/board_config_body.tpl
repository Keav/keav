...
<tr>
      ...
      <td class="row2"><input type="radio" name="memberlist_access" value="{MEMBERLIST_ACCESS_ALL}" {MEMBERLIST_ACCESS_ALL_CHECKED} />{L_ALL}&nbsp;

&nbsp;<input type="radio" name="memberlist_access" value="{MEMBERLIST_ACCESS_REG}" {MEMBERLIST_ACCESS_REG_CHECKED} />{L_REG}&nbsp; &nbsp;<br /><input

type="radio" name="memberlist_access" value="{MEMBERLIST_ACCESS_MOD}" {MEMBERLIST_ACCESS_MOD_CHECKED} />{L_MOD}&nbsp; &nbsp;<input type="radio"

name="memberlist_access" value="{MEMBERLIST_ACCESS_ADMIN}" {MEMBERLIST_ACCESS_ADMIN_CHECKED} />{L_ADMIN}</td>
   </tr>
