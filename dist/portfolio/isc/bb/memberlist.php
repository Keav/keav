...
// Memberlist sorting
//
$mode_types_text = array($lang['Sort_Joined'], $lang['Sort_Visited'], $lang['Sort_Username'], $lang['Sort_Location'], $lang['Sort_Posts'], $lang['Sort_Email'],  $lang['Sort_Website'], $lang['Sort_Top_Ten']);
$mode_types = array('joined', 'visitdate', 'username', 'location', 'posts', 'email', 'website', 'topten');
...
// If user_session_time is zero, then user has never visited.
      ...
      {
         $lastvisit = create_date('D M d, Y H:i', $row['user_session_time'], $board_config['board_timezone']);
      }
