...
if( isset($HTTP_POST_VARS['submit']) )
{
   ...
   $template->assign_vars(array(
      'META' => '<meta http-equiv="refresh" content="3;url=' . append_sid("admin_forums.$phpEx") . '">')
   );
   $message = $lang['Forum_auth_updated'] . '<br /><br />' . sprintf($lang['Click_return_forumadmin'],  '<a href="' . append_sid("admin_forums.$phpEx") . '">', "</a>");
