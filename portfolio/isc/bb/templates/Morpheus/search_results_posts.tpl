...
<tr>
	<td width="150" class="row" align="center" valign="top" style="padding: 2px;">
		...
		<table width="100%" cellspacing="5" cellpadding="0">
			...
			<tr><td align="left" nowrap="nowrap"><span class="postdetails">{searchresults.TOPIC_REPLIES}</span></td></tr>
			<tr><td align="left" nowrap="nowrap"><span class="postdetails">{searchresults.TOPIC_VIEWS}</span></td></tr>
		</table>
