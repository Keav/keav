...
<!-- BEGIN quote_username_open --><table width="90%" cellspacing="1" cellpadding="2" border="0" align="center" class="quote">
<tr> 
	<td class="quote_user">{USERNAME} {L_WROTE}:</td>
</tr>
<tr>
	<td class="quote"><!-- END quote_username_open -->
<!-- BEGIN quote_open --><table width="90%" cellspacing="1" cellpadding="2" border="0" align="center" class="quote">
<tr>
...
<!-- BEGIN code_open --><table width="90%" cellspacing="1" cellpadding="2" border="0" align="center" class="code">
<tr> 
	<td class="code_header">{L_CODE}:</td>
</tr>
<tr>
