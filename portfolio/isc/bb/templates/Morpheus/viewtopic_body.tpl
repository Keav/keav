...
<tr> 
	...
	<td class="row" width="100%"><input type="text" name="subject" size="45" maxlength="60" style="width:450px" tabindex="2" class="post" value="" /></td>
</tr>
<tr> 
	...
	<td class="row" width="100%"><textarea name="message" rows="15" cols="35" wrap="virtual" style="width:450px" tabindex="3" class="post"></textarea></td>
</tr>
<tr> 
