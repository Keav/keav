...
<tr>
	...
	<div id="header-box">
		...
		<!-- BEGIN switch_user_logged_out -->
 		<div id="header-login"><form method="post" action="{S_LOGIN_ACTION}"><input type="hidden" name="autologin" value="checked" />
			<input class="login-input" type="text" name="username" alt="{L_USERNAME}" title="{L_USERNAME}" /><br />
			<input class="login-input" type="password" name="password" maxlength="32" alt="{L_PASSWORD}" title="{L_PASSWORD}" /><br />
			<input class="login-submit" type="submit" name="login" value="{L_LOGIN}" />
		</form></div>
